...
+) Using for all timer
*/
void BASE_TIMER_Init(volatile void* TIMER, unsigned long Prescale, unsigned long ReloadValue);                            //Prescale & ReloadValue: 16 bit
//==============================================================================================================================================================
/*
+) NOTE:
...
*/
void BASE_TIMER_GeneratePWM(volatile void* TIMER, unsigned long Channel, unsigned long Duty, unsigned long IDLE_IsHigh);   //Channel: 8 bit; Duty: 16 bit
//==============================================================================================================================================================
