...
typedef struct
{
  BUNION(CR, unsigned long,                      //              0x0000'007F     Control register
    T                                   , 7,    //0:6           0x7F            7-bit counter (MSB to LSB)
    WDGA                                , 1,    //7             0               Activation bit
    _reserved                           , 24);
  BUNION(CFR, unsigned long,                     //              0x0000'007F     Configuration register
...
typedef struct
{
  RSTRUCT(CR, unsigned long,                     //              0x0000'007F     Control register
    T                                   [7],    //0:6           0x7F            7-bit counter (MSB to LSB)
    WDGA                                   ,    //7             0               Activation bit
    _reserved                           [24]);
  RSTRUCT(CFR, unsigned long,                    //              0x0000'007F     Configuration register
    W                                   [7],    //0:6           0x7F            7-bit window value
    WDGTB                               [2],    //7-8           0               Timer base
