...
typedef struct
{
  BUNION(CR1, unsigned long,                     //              0x0000'0000     I2C Control register 1
    ...
    _reserved2                          , 16);
  BUNION(CR2, unsigned long,                     //              0x0000'00000    I2C Control register 2
    ...
    _reserved1                          , 19);
  BUNION(OAR1, unsigned long,                    //              0x0000'0000     I2C Own address register 1
    ADD1                                , 10,   //0:9           0
    _reserved                           , 5,
    ADDMODE                             , 1,    //15            0               Addressing mode (slave mode)
    _reserved1                          , 16);
  BUNION(OAR2, unsigned long,                    //              0x0000'0000     I2C Own address register 2
    ENDUAL                              , 1,    //0             0               Dual addressing mode enable
    ADD2                                , 7,    //1:7           0               Interface address
    _reserved                           , 24);
  unsigned long DR;                              //              0x0000'0000     I2C Data register
  BUNION(SR1, unsigned long,                     //              0x0000'0000     I2C Status register 1
    ...
    _reserved2                          , 16);
  BUNION(SR2, const unsigned long,               //              0x0000'0000
    ...
    _reserved1                          , 16);
  BUNION(CCR, unsigned long,                     //              0x0000'0000     I2C Clock control register
    ...
    _reserved1                          , 16);
  unsigned long TRISE;                           //              0x0000'0002     Maximum rise time in Fm/Sm mode
} I2C_TypeDef;

typedef struct
{
  RSTRUCT(CR1, unsigned long,                    //              0x0000'0000     I2C Control register 1
    ...
    _reserved2                          [16]);
  RSTRUCT(CR2, unsigned long,                    //              0x0000'00000    I2C Control register 2
    FREQ                                [6],    //0:5           0               Peripheral clock frequency
    _reserved                           [2],
    ...
    _reserved1                          [19]);
  RSTRUCT(OAR1, unsigned long,                   //              0x0000'0000     I2C Own address register 1
    ADD1                                [10],   //0:9           0
    _reserved                           [5],
    ADDMODE                                ,    //15            0               Addressing mode (slave mode)
    _reserved1                          [16]);
  RSTRUCT(OAR2, unsigned long,                   //              0x0000'0000     I2C Own address register 2
    ENDUAL                                 ,    //0             0               Dual addressing mode enable
    ADD2                                [7],    //1:7           0               Interface address
    _reserved                           [24]);
  unsigned long DR[32];                          //              0x0000'0000     I2C Data register
  RSTRUCT(SR1, unsigned long,                    //              0x0000'0000     I2C Status register 1
    ...
    _reserved2                          [16]);
  RSTRUCT(SR2, const unsigned long,              //              0x0000'0000
    ...
    PEC                                 [8],    //8:15          0               Packet error checking register
    _reserved1                          [16]);
  RSTRUCT(CCR, unsigned long,                    //              0x0000'0000     I2C Clock control register
    CCR                                 [12],   //0:11          0               Clock control register in Fm/Sm mode (Master mode)
    _reserved                           [2],
    DUTY                                   ,    //14            0               Fm mode duty cycle
    FS                                     ,    //15            0               I2C master mode selection
    _reserved1                          [16]);
  unsigned long TRISE[32];                       //              0x0000'0002     Maximum rise time in Fm/Sm mode
} I2C_BITBAND_TypeDef;
//====================================================================================================================================================
//====================================================================================================================================================
//====================================================================================================================================================
...
void I2C_Init(volatile I2C_TypeDef* I2C, unsigned long EdgeTime);
//====================================================================================================================================================
typedef union
{
