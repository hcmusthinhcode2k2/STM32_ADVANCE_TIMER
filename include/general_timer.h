...
typedef struct
{
  BUNION(CR1, unsigned long,                     //              0x0000'0000     TIMx control register 1
    ...
    _reserved                           , 22);
  BUNION(CR2, unsigned long,                     //              0x0000'0000     TIMx control register 2
    _reserved                           , 3,
    CCDS                                , 1,    //3             0               Capture/compare DMA selection
    MMS                                 , 3,    //4:6           0               Master mode selection
    TI1S                                , 1,    //7             0               TI1 selection
    _reserved1                          , 24);
  BUNION(SMCR, unsigned long,                    //              0x0000'0000     TIMx slave mode control register
    ...
    _reserved1                          , 16);
  BUNION(DIER, unsigned long,                    //              0x0000'0000     TIMx DMA/interrupt enable register
    ...
    _reserved2                          , 17);
  BUNION(SR, unsigned long,                      //              0x0000'0000     TIMx status register
    ...
    _reserved2                          , 19);
  BUNION(EGR, unsigned long,                     //              0x0000'0000     TIMx event generation register
  ...
  BUNION(CCER, unsigned long,                    //              0x0000'0000     TIMx capture/compare enable register
    ...
    _reserved3                          , 18);
  unsigned long CNT;                             //              0x0000'0000     TIMx counter
  unsigned long PSC;                             //              0x0000'0000     TIMx prescaler
  unsigned long ARR;                             //              0x0000'FFFF     TIMx auto-reload register
  unsigned long _reserved;
  unsigned long CCR1;                            //              0x0000'0000     TIMx capture/compare register
  unsigned long CCR2;                            //              0x0000'0000     TIMx capture/compare register
  unsigned long CCR3;                            //              0x0000'0000     TIMx capture/compare register
  unsigned long CCR4;                            //              0x0000'0000     TIMx capture/compare register
  unsigned long _reserved1;
  BUNION(DCR, unsigned long,                     //              0x0000'0000     TIMx DMA control register
    DBA                                 , 5,    //0:4           0               DMA base address
    _reserved                           , 3,
    DBL                                 , 5,    //8:12          0               DMA burst length
    _reserved1                          , 19);
  unsigned long DMAR;                            //              0x0000'0000     TIMx DMA address for full transfer
} GENERAL_TIMER_TypeDef;

typedef struct
{
  RSTRUCT(CR1, unsigned long,                    //              0x0000'0000     TIMx control register 1
    ...
    CKD                                 [2],    //8-9           0               Clock division
    _reserved                           [22]);
  RSTRUCT(CR2, unsigned long,                    //              0x0000'0000     TIMx control register 2
    _reserved                           [3],
    CCDS                                   ,    //3             0               Capture/compare DMA selection
    MMS                                 [3],    //4:6           0               Master mode selection
    TI1S                                   ,    //7             0               TI1 selection
    _reserved1                          [24]);
  RSTRUCT(SMCR, unsigned long,                   //              0x0000'0000     TIMx slave mode control register
    SMS                                 [3],    //0:2           0               Slave mode selection
    _reserved                              ,
    TS                                  [3],    //4:6           0               Trigger selection
    ...
    _reserved1                          [16]);
  RSTRUCT(DIER, unsigned long,                   //              0x0000'0000     TIMx DMA/interrupt enable register
    ...
    _reserved2                          [17]);
  RSTRUCT(SR, unsigned long,                     //              0x0000'0000     TIMx status register
    ...
    _reserved2                          [19]);
  RSTRUCT(EGR, unsigned long,                    //              0x0000'0000     TIMx event generation register
  ...
  RSTRUCT(CCER, unsigned long,                   //              0x0000'0000     TIMx capture/compare enable register
    ...
    _reserved3                          [18]);
  unsigned long CNT[32];                         //              0x0000'0000     TIMx counter
  unsigned long PSC[32];                         //              0x0000'0000     TIMx prescaler
  unsigned long ARR[32];                         //              0x0000'FFFF     TIMx auto-reload register
  unsigned long _reserved[32];
  unsigned long CCR1[32];                        //              0x0000'0000     TIMx capture/compare register
  unsigned long CCR2[32];                        //              0x0000'0000     TIMx capture/compare register
  unsigned long CCR3[32];                        //              0x0000'0000     TIMx capture/compare register
  unsigned long CCR4[32];                        //              0x0000'0000     TIMx capture/compare register
  unsigned long _reserved1[32];
  RSTRUCT(DCR, unsigned long,                    //              0x0000'0000     TIMx DMA control register
    DBA                                 [5],    //0:4           0               DMA base address
    _reserved                           [3],
    DBL                                 [5],    //8:12          0               DMA burst length
    _reserved1                          [19]);
  unsigned long DMAR[32];                        //              0x0000'0000     TIMx DMA address for full transfer
