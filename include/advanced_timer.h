...
typedef struct
{
  BUNION(CR1, unsigned long,                     //              0x0000'0000     TIM1 and TIM8 control register 1
    ...
    _reserved                           , 22);
  BUNION(CR2, unsigned long,                     //              0x0000.0000     TIM1 and TIM8 control register 2
    ...
    _reserved1                          , 17);
  BUNION(SMCR, unsigned long,                    //              0x0000.0000     TIM1 and TIM8 slave mode control register
    ...
    _reserved1                          , 16);
  BUNION(DIER, unsigned long,                    //              0x0000'0000     TIM1 and TIM8 DMA/interrupt enable register
    ...
    _reserved                           , 17);
  BUNION(SR, unsigned long,                      //              0x0000'0000     TIM1 and TIM8 status register
    ...
    _reserved1                          , 19);
  BUNION(EGR, unsigned long,                     //              0x0000.0000     TIM1 and TIM8 event generation register
  ...
  BUNION(CCER, unsigned long,                    //              0x0000.0000     TIM1 and TIM8 capture/compare enable register
    ...
    _reserved                           , 18);
  unsigned long CNT;                             //              0x0000.0000     TIM1 and TIM8 counter
  unsigned long PSC;                             //              0x0000.0000     TIM1 and TIM8 prescaler
  unsigned long ARR;                             //              0x0000.FFFF     TIM1 and TIM8 auto-reload register
  unsigned long RCR;                             //              0x0000.0000     TIM1 and TIM8 repetition counter register
  unsigned long CCR1;                            //              0x0000.0000     TIM1 and TIM8 capture/compare register
  unsigned long CCR2;                            //              0x0000.0000     TIM1 and TIM8 capture/compare register
  unsigned long CCR3;                            //              0x0000.0000     TIM1 and TIM8 capture/compare register
  unsigned long CCR4;                            //              0x0000.0000     TIM1 and TIM8 capture/compare register
  BUNION(BDTR, unsigned long,                    //              0x0000.0000     TIM1 and TIM8 break and dead-time register
    ...
    _reserved                           , 16);
  BUNION(DCR, unsigned long,                     //              0x0000.0000     TIM1 and TIM8 DMA control register
    DBA                                 , 5,    //0:4           0               DMA base address
    _reserved                           , 3,
    DBL                                 , 5,    //8:11          0               DMA burst length
    _reserved1                          , 19);
  unsigned long DMAR;                            //0x0000.0000                   TIM1 and TIM8 DMA address for full transfer
} ADVANCED_TIMER_TypeDef;

typedef struct
{
  RSTRUCT(CR1, unsigned long,                    //              0x0000'0000     TIM1 and TIM8 control register 1
    ...
    CKD                                 [2],    //8-9           0               Clock division
    _reserved                           [22]);
  RSTRUCT(CR2, unsigned long,                     //              0x0000.0000     TIM1 and TIM8 control register 2
    ...
    _reserved1                          [17]);
  RSTRUCT(SMCR, unsigned long,                    //              0x0000.0000     TIM1 and TIM8 slave mode control register
    SMS                                 [3],    //0:2           0               Slave mode selection
    _reserved                              ,
    TS                                  [3],    //4:6           0               Trigger selection
    ...
    _reserved1                          [16]);
  RSTRUCT(DIER, unsigned long,                    //              0x0000'0000     TIM1 and TIM8 DMA/interrupt enable register
    ...
    _reserved                           [17]);
  RSTRUCT(SR, unsigned long,                      //              0x0000'0000     TIM1 and TIM8 status register
    ...
    _reserved1                          [19]);
  RSTRUCT(EGR, unsigned long,                    //              0x0000.0000     TIM1 and TIM8 event generation register
  ...
  RSTRUCT(CCER, unsigned long,                    //              0x0000.0000     TIM1 and TIM8 capture/compare enable register
    ...
    _reserved                           [18]);
  unsigned long CNT[32];                         //              0x0000.0000     TIM1 and TIM8 counter
  unsigned long PSC[32];                         //              0x0000.0000     TIM1 and TIM8 prescaler
  unsigned long ARR[32];                         //              0x0000.FFFF     TIM1 and TIM8 auto-reload register
  unsigned long RCR[32];                         //              0x0000.0000     TIM1 and TIM8 repetition counter register
  unsigned long CCR1[32];                        //              0x0000.0000     TIM1 and TIM8 capture/compare register
  unsigned long CCR2[32];                        //              0x0000.0000     TIM1 and TIM8 capture/compare register
  unsigned long CCR3[32];                        //              0x0000.0000     TIM1 and TIM8 capture/compare register
  unsigned long CCR4[32];                        //              0x0000.0000     TIM1 and TIM8 capture/compare register
  RSTRUCT(BDTR, unsigned long,                    //              0x0000.0000     TIM1 and TIM8 break and dead-time register
    DT                                  [8],    //0:7           0               Dead-time generator setup
    LOCK                                [2],    //8-9           0               Lock configuration
    ...
    _reserved                           [16]);
  RSTRUCT(DCR, unsigned long,                     //              0x0000.0000     TIM1 and TIM8 DMA control register
    DBA                                 [5],    //0:4           0               DMA base address
    _reserved                           [3],
    DBL                                 [5],    //8:11          0               DMA burst length
    _reserved1                          [19]);
