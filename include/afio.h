...
typedef struct
{                                       
  BUNION(EVCR, unsigned long,                    //              0x0000'0000     Event control register
    PIN                                 , 4,    //0:3           0               Pin selection
    PORT                                , 3,    //4:6           0               Port selection
    EVOE                                , 1,    //7             0               Event output enable
    _reserved                           , 24);
  BUNION(MAPR, unsigned long,                    //              0x0000'0000     AF remap and debug I/O configuration register
  ...
  union
  {
    RSTRUCT(REGS, unsigned long, r1, r2, r3, r4);
  ...
  BUNION(MAPR2, unsigned long,                   //              0x0000'0000     AF remap and debug I/O configuration register2
    TIM15                               , 1,    //0             0
    TIM16                               , 1,    //1             0
    TIM17                               , 1,    //2             0
    CEC                                 , 1,    //3             0
...
typedef struct
{
  RSTRUCT(EVCR, unsigned long,                   //              0x0000'0000     Event control register
    PIN                                 [4],    //0:3           0               Pin selectio
    PORT                                [3],    //4:6           0               Port selection
    EVOE                                   ,    //7             0               Event output enable
    _reserved                           [24]);
  RSTRUCT(MAPR, unsigned long,                   //              0x0000'0000     AF remap and debug I/O configuration register
    ...
    /*** connectivity line devices ***/
    _reserved1                             );
  RSTRUCT(EXTICR, unsigned long,                 //              0x0000'0000     External interrupt configuration register
    EXTI0                               [4],    //0:3
    EXTI1                               [4],    //4:7
    EXTI2                               [4],    //8:11
    EXTI3                               [4],    //12:15
  ...
  RSTRUCT(MAPR2, unsigned long,                  //              0x0000'0000     AF remap and debug I/O configuration register2
    TIM15                                  ,    //0             0
    TIM16                                  ,    //1             0
    TIM17                                  ,    //2             0
    CEC                                    ,    //3             0
