...
typedef struct
{
  BUNION(CRH, unsigned long,                     //              0x0000'0000     RTC control register high
    SECIE                               , 1,    //              0               Second interrupt enable
    ALRIE                               , 1,    //              0               Alarm interrupt enable
    OWIE                                , 1,    //              0               Overflow interrupt enable
    _reserved                           , 29);
  BUNION(CRL, unsigned long,                     //              0x0000'0020     RTC control register low
    ...
    _reserved                           , 26);
  RSTRUCT(PRL, unsigned long,                    //                              RTC prescaler load register
    HIGH,                                       //              0x0000'0000     (16 bits low is used)
    LOW);                                       //              0x0000'000C     (16 bits low is used)
  RSTRUCT(DIV, unsigned long,                    //                              RTC prescaler divider register
    const HIGH,                                 //              0x0000'0000     (4 bits low is used)
    const LOW);                                 //              0x0000'8000     (16 bits low is used)
  RSTRUCT(CNT, unsigned long,                    //                              RTC counter register
    HIGH,                                       //              0x0000'0000     (16 bits low is used)
    LOW);                                       //              0x0000'0000     (16 bits low is used)
  RSTRUCT(ALR, unsigned long,                    //                              RTC alarm register
...
typedef struct
{
  RSTRUCT(CRH, unsigned long,                    //              0x0000'0000     RTC control register high
    SECIE                                  ,    //              0               Second interrupt enable
    ALRIE                                  ,    //              0               Alarm interrupt enable
    OWIE                                   ,    //              0               Overflow interrupt enable
    _reserved                           [29]);
  RSTRUCT(CRL, unsigned long,                    //              0x0000'0020     RTC control register low
