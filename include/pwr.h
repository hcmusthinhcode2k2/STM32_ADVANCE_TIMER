...
typedef struct
{
  BUNION(CR, unsigned long,                      //              0x0000'0000     Power control register
    ...
    _Reserved                           , 23);
  BUNION(CSR, unsigned long,                     //              0x0000'0000     Power control/status register
...
typedef struct
{
  RSTRUCT(CR, unsigned long,                     //              0x0000'0000     Power control register
    ...
    _Reserved                           [23]);
  RSTRUCT(CSR, unsigned long,                    //              0x0000'0000     Power control/status register
