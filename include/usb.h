...
//typedef struct
//{
//  BUNION(Endpoint[8], unsigned long,             //              0x0000'0000     USB endpoint n register
...
//  BUNION(CNTR, unsigned long,                    //              0x0000'0003     USB control register
...
//    _reserved1                          , 16);
//  BUNION(ISTR, unsigned long,                    //              0x0000'0000     USB interrupt status register
...
//    _reserved1                          , 16);
//  BUNION(FNR, const unsigned long,               //              0x0000'0---     USB frame number register
...
//    _reserved                           , 16);
//  BUNION(DADDR, unsigned long,                   //              0x0000'0000     USB device address
//    ADD                                 , 7,    //0:6           0               Device address
//    EF                                  , 1,    //7             0               Enable function
//    _reserved                           , 24);
//  unsigned long BTABLE;                          //              0x0000'0000     Buffer table address (bit 15->3 is used)
//} USB_TypeDef;
//
//typedef struct
//{
//  RSTRUCT(Endpoint[8], unsigned long,            //              0x0000'0000     USB endpoint n register
//    EA                                  [4],    //0:3           0               Endpoint address
//    STAT_TX                             [2],    //4:5           0               Status bits, for transmission transfers
...
//    _reserved                           [16]);
//  unsigned long _reserved[8][32];
//  RSTRUCT(CNTR, unsigned long,                   //              0x0000'0003     USB control register
...
//    _reserved1                          [16]);
//  RSTRUCT(ISTR, unsigned long,                   //              0x0000'0000     USB interrupt status register
//    const EP_ID                         [4],    //0:3           0               Endpoint Identifier
...
//    _reserved1                          [16]);
//  RSTRUCT(FNR, const unsigned long,              //              0x0000'0---     USB frame number register
//    FN                                  [11],   //0:10                          Frame number
//    LSOF                                [2],    //11-12         0               Lost SOF
//    LCK                                    ,    //13            0               Locked
...
//    _reserved                           [16]);
//  RSTRUCT(DADDR, unsigned long,                  //              0x0000'0000     USB device address
//    ADD                                 [7],    //0:6           0               Device address
//    EF                                     ,    //7             0               Enable function
//    _reserved                           [24]);
//  unsigned long BTABLE[32];                      //              0x0000'0000     Buffer table address (bit 15->3 is used)
//} USB_BITBAND_TypeDef;
//
//
///*
